...
class AECSCore {
  ...
  configure(options = {}) {
    this.config = {
      ...
      suppressionMapMaxSize: Number.parseInt(options.suppressionMapMaxSize || process.env.AECS_SUPPRESSION_MAP_MAX_SIZE || '10000', 10),
    ...
    this.dispatcher = new Dispatcher({
      ...
      suppressionMapMaxSize: this.config.suppressionMapMaxSize,
      ...
      telemetryWebhookUrlSecondary: this.config.telemetryWebhookUrlSecondary,
      telemetryFatalWebhookUrl: this.config.telemetryFatalWebhookUrl,
      telemetryFatalWebhookUrlSecondary: this.config.telemetryFatalWebhookUrlSecondary,
  ...
  setTelemetryRouting(options = {}) {
    ...
    this.config = {
      ...
      telemetryWebhookUrlSecondary: options.telemetryWebhookUrlSecondary !== undefined ? options.telemetryWebhookUrlSecondary : this.config.telemetryWebhookUrlSecondary,
      ...
      telemetryFatalWebhookUrlSecondary: options.telemetryFatalWebhookUrlSecondary !== undefined ? options.telemetryFatalWebhookUrlSecondary : this.config.telemetryFatalWebhookUrlSecondary,
