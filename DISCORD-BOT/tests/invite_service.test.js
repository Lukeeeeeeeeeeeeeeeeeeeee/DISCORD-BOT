...
describe('invite service interaction acknowledgment handling', () => {
  let consoleErrorSpy;
  ...
  test('defers before role checks and edits deferred reply for recruiter-gate errors', async () => {
    ...
    const inviteService = require('../src/services/recruiting/invite-service');

    await inviteService.execute(interaction);
