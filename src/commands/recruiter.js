...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (sub === 'buy') {
      ...
      const ITEMS = { 'nickname': 30, 'custom-vc': 25, 'custom-role': 50, 'custom-suggestion': 100 };
      ...
      return interaction.reply({ content: `Purchased ${item} for ${cost} points. Staff will provision the item if needed.`, ephemeral: true });
    }
